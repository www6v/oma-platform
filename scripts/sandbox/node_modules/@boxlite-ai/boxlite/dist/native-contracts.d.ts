...
export interface NativeBoxliteRestOptionsConstructor {
    new (url: string, credential?: ApiKeyCredential | null, prefix?: string | null): NativeBoxliteRestOptions;
}
...
export interface JsSnapshotHandle {
    create(name: string, options?: JsSnapshotOptions | null): Promise<JsSnapshotInfo>;
...
export interface JsBoxlite {
    ...
    getOrCreate(options: JsBoxOptions, name?: string | null): Promise<JsGetOrCreateResult>;
...
//# sourceMappingURL=native-contracts.d.ts.map