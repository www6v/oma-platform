...
function seedTeamFixture(sessionId) {
  ...
  const uv = spawnSync('uv', ['run', 'python', '../scripts/e2e/seed-team-console-fixture.py'], {
  ...
  const py = spawnSync('python3', [path.join(rootDir, 'scripts/e2e/seed-team-console-fixture.py')], {
    cwd: path.join(rootDir, 'harness'),
    env,
    encoding: 'utf8',
  });
