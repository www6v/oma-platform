...
#
# Usage:
#   ./scripts/e2e/smoke-subagent-console-e2e.sh
#   SUBAGENT_E2E_HEADED=1 ./scripts/e2e/smoke-subagent-console-e2e.sh
set -euo pipefail
...
if [[ ! -d "${E2E_DIR}/node_modules/playwright" ]]; then
  echo "[subagent-console] installing Playwright deps in scripts/e2e…"
