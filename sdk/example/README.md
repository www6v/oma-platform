...
| `CMA_verify_with_outcome_grader.ipynb` | `example4/outcome_grader.py` | `example4/outcome_grader_main.py` | `example4/rubric.md` |
...
| OG5 EV charging live soak | `example4/outcome_grader_ev_charging.py` | `example4/outcome_grader_ev_charging_main.py` | `example4/ev_charging/` |
...
Outcome grader CI: Go `TestOutcomeGrader*`; SDK `tests/test_outcome_cookbook.py`
(opt-in live EV soak: `OMA_RUN_LIVE_OUTCOME_EV=1`).
